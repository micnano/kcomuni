...
$cli = eZCLI::instance();
$db = eZDB::instance();
$script = eZScript::instance( array( 'description' => ( "COMUNI- SCRIPT MODIFICA NUMERO PRATICA\n\n" .
                                                        "\n" .
                                                        "\n" .
                                                        "\n" .
                                                        "\n" .
...
foreach ($pratiche as $pratica) {
	...
	$nome=$pratica->attribute("name");
	$nomea = explode("-",$nome);
	$nomer= array_reverse($nomea);
	$numero=intval($nomer[0]);
	$params= array();
	$attributesData = array() ;
	$attributesData['numberc'] =  $numero;
	$attributesData['number'] =  $nomer[0];
